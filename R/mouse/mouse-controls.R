## mouse - neg and pos control (can we do some kind of decontam?)
...
# get data
load("R/mouse/mouse-fungi-ps-filtered.RData")
...
# save
ggsave(filename = "R/updated-silvermanlab-analyses/working-plots/mouse-controls.png", dpi = 600)
...
ggbarplot(df, x = "Genus", y = "Abundance", 
          fill = "Control",
          #sort.val = "desc",
          label = TRUE,
...
ggsave(filename = "R/updated-silvermanlab-analyses/working-plots/mouse-control-counts.png", dpi = 600)
...
table(contamdf.prev$contaminant) # this identifies 1 contaminant; Pyricularia Genus
...
# save
save(pssave, file = "data/mouse-phyloseq-filtered.RData")
